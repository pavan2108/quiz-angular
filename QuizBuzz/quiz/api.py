...
from quiz.models import Question, Quiz, QuizTaker, Answer, UsersAnswer
from django.db.models import Q
from quiz.serializers import QuizListSerializer, QuizResultSerializer, QuizDetailSerializer, MyQuizListSerializer, UsersAnswerSerializer
...
class QuizListAPI(generics.ListAPIView):
    ...
    def get_queryset(self, *args, **kwargs):
        ...
        queryset = Quiz.objectsfilter(roll_out = True).exclude(quiztaker__user = self.request.user)
        query = self.request.GET.get("q")
